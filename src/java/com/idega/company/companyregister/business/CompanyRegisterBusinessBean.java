...
public class CompanyRegisterBusinessBean extends IBOServiceBean implements CompanyRegisterBusiness, UserGroupPlugInBusiness {
	...
	public boolean updateEntry(
		...
		try {
			...
			CompanyRegister reg = getEntryBySSN(ssn);
			if (reg == null) {
...
//			userBiz.updateUsersCoAddressOrCreateIfDoesNotExist((Integer) user.getPrimaryKey(), address, postalCodeId, null, null, null, null, null);
	...
	public void updateUserPersonalID(String oldPersonalID, String newPersonalID) throws IBOLookupException{
		CompanyRegister reg = getEntryBySSN(oldPersonalID);
	...
	public void updateUserOldID(String oldID, String personalID) throws IBOLookupException{
		CompanyRegister reg = getEntryBySSN(personalID);
	...
	protected CompanyRegisterHome getNationalRegisterHome() {
...
//		list.add(new CompanyRegisterFileImportHandlerPlugin());
		return list;
	}
